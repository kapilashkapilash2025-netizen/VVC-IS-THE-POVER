...
A framework-free, accessible digital school platform built with HTML, CSS, and JavaScript.
...
The portal follows the supplied Vavuniya Vipulanantha College reference. The static admin modal is device-local demonstration functionality, not secure production authentication, and must not be used for confidential or personal data.
